...
const dbConfig = { host: process.env.DB_HOST || 'localhost', user: process.env.DB_USER || 'alumno', password: process.env.DB_PASS, database: process.env.DB_NAME || 'freshbox', port: process.env.DB_PORT || 3306 };
